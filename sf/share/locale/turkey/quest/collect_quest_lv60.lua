...
quest collect_quest_lv60  begin
        ...
        state go_to_disciple begin
                ...
                when button or info begin
                        ...
                        say("Buz toplarý, bu buz daðýnin ahartarlarý.")
				...
				say("")
				---                                                   l
                                say("Buz toplarýný bulduktan sonra ")
		...
		when 20084.chat."GM: collect_quest_lv60.skip_delay" with pc.count_item(30050) >0 and pc.is_gm() and get_time() <= pc.getqf("duration") begin
            ...
            when 20084.chat."Buz topu mu buldun? " with pc.count_item(30050) >0   begin
				...
				say("")
                                ---                                                   l
                                say("Oh!! Buldun...")
                                say("Önce incelemem lazým...")
                                say("Büyütecim nerede..")
                                say("Bir dakika...")
                                say("")
        ...
        state key_item begin
                ...
                when button or info begin
                        if pc.count_item(30223) >0 then
                                say_title("Aurtumryunun Ruh Taþý'ný kazandýn.")
                                say("")
                                ---                                                   l
                                say("Nihayet, buz ruhunun taþýný kazandýn.")
                                say("Onu Chaegirab'a götürmelisin.")
                                say("")
                                return
                        end

                        say_title("Buz daðýndan buz ruhunun taþý lazým")
                        say("")
                        ---                                                   l
				...
				if npc.get_race() == 1104 or npc.get_race() == 1105 or npc.get_race() == 1105 or npc.get_race() == 1107 then
                        ...
                        if s==1 then
                                ...
                                send_letter("Aurtumryunun Ruh Taþý'ný bulmayý baþardýn.")
                        end
                end
				end
		...
		pc.count_item(30223) > 0  begin
			...
			---                                                   l
                        ...
                        say("Bu bir gizli reçete,")
                        say("onun içinde güç artýrýmý var.")
                        say("Baek-Go'ya götürdüðünde ödülünü alacaksýn.")
                        say("Ýyi Eðlenceler!")
                        say("Senin yardýmýn sayesinde artýk")
                        say("buz daðý ile ilgili her þeyi biliyorum.")
                        say("")
